class USPSData:
    ...
    def addColumns(self):
        ...
        for index, row in self.df.iterrows():
            ...
            self.df.set_value(index, 'TOTAL_ADDRESS_COUNT', total_addresses)
            ...
            self.df.set_value(index, 'TOTAL_VAC_COUNT', total_vacant)
            ...
            self.df.set_value(index, 'TOTAL_PQV_PQNS_IS', total_is)
            ...
            self.df.set_value(index, 'TOTAL_NO_STAT', total_nostat)
            temp_avg_v_r = row.AVG_VAC_R
            temp_avg_v_b = row.AVG_VAC_B
            total_avg = temp_avg_v_r + temp_avg_v_b
            self.df.set_value(index, 'TOTAL_AVG_VAC', total_avg)
